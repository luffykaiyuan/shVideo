...
CREATE TABLE `advertinfo`  (
  ...
  `advert_location` varchar(4) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '广告位置',
  `add_time` datetime(0) NULL DEFAULT NULL COMMENT '添加时间',
  `status` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '1' COMMENT '状态(0.删除1.可用2.在用)',
...
CREATE TABLE `run_water`  (
  ...
  `money` varchar(8) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '金额',
  `water_type` varchar(4) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '流水类型（1.充值2.返利）',
  `add_time` datetime(0) NULL DEFAULT NULL COMMENT '添加时间',
  `status` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '1' COMMENT '状态',
...
CREATE TABLE `user_invite`  (
  ...
  `invite_num` int NULL DEFAULT NULL COMMENT '邀请人数',
  PRIMARY KEY (`username`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '邀请表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `userinfo`  (
  ...
  `password` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '密码',
  `nick_name` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '昵称',
  `money` varchar(8) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '余额',
  ...
  `card_type` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '卡类型（0.没有1.月卡2.季卡3.年卡）',
  `look_num` int NULL DEFAULT 1 COMMENT '观看次数',
  `rank_id` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '等级',
  `add_time` datetime(0) NULL DEFAULT NULL COMMENT '添加时间',
...
CREATE TABLE `video_tag`  (
  ...
  `video_id` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '视频Id',
  `tag_name` varchar(16) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '标签名',
  `add_time` datetime(0) NULL DEFAULT NULL COMMENT '添加时间',
  `status` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '1' COMMENT '状态',
